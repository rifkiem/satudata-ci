...
<body>
    ...
    <div class="container" style="margin-top: 80px">
        ...
        <p align="right">
             <a href="<?php echo base_url() ?>sk/tambah/" class="btn btn-md btn-primary">Tambah</a>
            ...
            <table id="table" class="table table-striped table-bordered table-hover">
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url() ?>sk/edit/<?php echo $hasil->id_sk ?>" class="btn btn-sm btn-primary">Edit</a>
                        
                        <a href="<?php echo base_url() ?>sk/hapus/<?php echo $hasil->id_sk ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin ingin menghapus data ini ?');">Hapus</a>
                    </td>
